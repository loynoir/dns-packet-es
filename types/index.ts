...
import { isV4Format as IPES_isV4Format, toBuffer as IPES_toBuffer, toString as IPES_toString } from 'ip-es';
...
export function rrrsig_encodingLength(sig) {
  return 20 + name_encodingLength(sig.signersName) + Buffer.byteLength(sig.signature);
}
